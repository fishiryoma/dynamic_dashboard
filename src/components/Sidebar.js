...
const ChartButton = ({ onClick, svgPaths, label }) => (
    <button
        onClick={onClick}
        className="w-full h-[100px] bg-rose-50 text-gray-800 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:bg-rose-200 flex flex-col items-center justify-center"
    >
        <svg
